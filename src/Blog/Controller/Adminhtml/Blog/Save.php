...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Moses\Blog\Model\Blog::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('moses_blog_blog');
            ...
            $this->dataPersistor->set('moses_blog_blog', $data);
