...
namespace Moses\Blog\Controller\Adminhtml\Blog;

class Edit extends \Moses\Blog\Controller\Adminhtml\Blog
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Moses\Blog\Model\Blog::class);
        ...
        $this->_coreRegistry->register('moses_blog_blog', $model);
